	...
	void Update () {
		...
		case STEP.CHECK_BUILDUP:
			...
			if (m_ojisanCheck.IsYes ()) {
				...
				SoundManager.Instance.PlaySE (SoundName.BUILDUP , "https://s3-ap-northeast-1.amazonaws.com/every-studio/app/pocket/zoo/ver02/AssetBundles/" + AssetBundles.Utility.GetPlatformName() + "/assets/assetbundles/se");
