...
public class BannerStaff : BannerBase {
	...
	public void Initialize( CsvStaffParam _CsvStaffParam ,int _iCostNokori){
		...
		m_bAbleUse = DataManager.user.AbleBuy (_CsvStaffParam.coin, _CsvStaffParam.ticket, _CsvStaffParam.cost, _iCostNokori, 0, 0, 0, 0, ref m_eReason);
	...
	public void Initialize( DataStaffParam _data , int _iCostNokori ){
		...
		m_bAbleUse = DataManager.user.AbleBuy (0, 0, staff_data.cost, _iCostNokori, 0, 0, 0, 0, ref m_eReason);
