...
public class CtrlParkMainFooter : MonoBehaviourEx {
	...
	void Update(){
		if (m_PageButton.ButtonPushed) {
			...
			case 0:
				SoundManager.Instance.PlayBGM (DataManager.Instance.config.Read(DataManager.Instance.KEY_BGM_BOOK)  , "https://s3-ap-northeast-1.amazonaws.com/every-studio/app/pocket/zoo/ver02/AssetBundles/" + AssetBundles.Utility.GetPlatformName() + "/assets/assetbundles/bgm");
			...
			case 1:
				...
				SoundManager.Instance.PlayBGM ( DataManager.Instance.config.Read(DataManager.Instance.KEY_BGM_WORK)  , "https://s3-ap-northeast-1.amazonaws.com/every-studio/app/pocket/zoo/ver02/AssetBundles/" + AssetBundles.Utility.GetPlatformName() + "/assets/assetbundles/bgm");
				...
				break;
			case 2:
				SoundManager.Instance.PlayBGM (DataManager.Instance.config.Read(DataManager.Instance.KEY_BGM_SHOP)  , "https://s3-ap-northeast-1.amazonaws.com/every-studio/app/pocket/zoo/ver02/AssetBundles/" + AssetBundles.Utility.GetPlatformName() + "/assets/assetbundles/bgm");
